...
// let call_fee_calculation

// if(operator =="Bakcell"){
//     call_fee_calculation=call_fee*0.5
//     console.log("Bakcell",call_fee_calculation)
// }else if(operator == "Azarcell"){
//     call_fee_calculation=call_fee*0.8
//     console.log("Bakcell",call_fee_calculation)
// }else if(operator =="Nar" ){
//     call_fee_calculation=call_fee*0.8
...
// }else{
//     console.log("sizin yasniz catmir hele usaqsiniz")
// }

// if(Feqan >=18){
//     console.log("Feqan bey sizin yasniz prava almaga catir: ",Feqan)
// }else{
...
//     console.log(`welcome Monday Party ${name}-sir`)
// }else {
//     console.log(`${name} your age not enough this party :( ${age}`)
// }
...
//         console.log(`welcome Monday Party ${name}-Sir`)
//     }else{
//         console.log(`not correct gender : ${gender}`)
//     }
// }else{
//     console.log(` ${name} your age not enough this party :( ${age} age`)
// }
...
// let home_Price =  +prompt("Home Price Enter: ");
...
// }else if(car_Number === "TR"){
//     console.log(`${car_Number}: this Turkish Car number `)

// }else if(car_Number ==="DE"){
//     console.log(`${car_Number}: this Germany Car number `)

// }else if(car_Number ==="RU"){
//     console.log(`${car_Number}: this Russia Car number `)

// }else if(car_Number === "UA"){
//     console.log(`${car_Number}: this Ukrainan Car number `)

// }else if(car_Number === "ZH"){
//     console.log(`${car_Number}: this Switzerland Car number `)
// }else if(car_Number === "USA"){
//     console.log(`${car_Number}: this United states Car number `)
...
// let Cam_infermation =alert("kamera isitfade qaydaları sadecu bu nömerler ile baxa bilersiz evin kamerasin\n"+
//                            "1-darvaza \n"+
//                            "2-heyit\n"+
//                            "3-qarac\n"+
//                            "4-baxça\n"+
